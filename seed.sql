...
-- Repair legacy starter rows. Older local DBs stored starter words as MANUAL and
-- had Japanese romaji values. Keep user-created words untouched unless they match
-- the fixed starter contexts/source.
...
('20000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000005', 'ADMIN')
...
('b0000000-0000-0000-0000-000000000002',
 false, '大丈夫です。とても自然に言えています！', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '1 day', NOW())
ON CONFLICT DO NOTHING;
